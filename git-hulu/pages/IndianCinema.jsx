...
const IndianCinema = () => {
  ...
  const [generes, setGeneres] = useState(current_year);
  ...
  const fetchMovies = async () => {
    const { data } = await axios
      .get(
        `https://api.themoviedb.org/3/discover/movie?api_key=${api_key}&language=en-US&sort_by=popularity.desc&page=${page}&primary_release_year=${generes}&with_original_language=hi|kn|ml|ta|te`,
      )
